...
import NiceLink from "@/components/links/NiceLink/Index";
    ...
    <div className="flex min-h-screen w-full flex-col items-stretch py-12">
      ...
      <div className="">
        <div className="grid grid-cols-3 gap-4">
          <div className="col-span-2 space-y-4 py-16">
